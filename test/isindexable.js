...
describe(`isindexable()`, function() {
    ...
    it(`should return true if its argument is an object with a numeric own length-property of 0`,
        function () {
            ...
            expecttrue( isindexable(obj) );
        }
    )

    it(`should return true if its argument is an object with an own property for the key 0 AND for the key equal to its length-property minus 1`,
        function () {
