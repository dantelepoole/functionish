...
describe( 'curry2()', function() {
        ...
        it('should return a function', function() {
            expect( curry2(collect) ).to.be.a('function');
        })
        ...
        describe( 'The result function', function() {
            ...
            it('should curry its first two arguments', function() {

                const currycollect = curry2(fakecollect);
            ...
            it('should call the targetfunction if it receives more than two arguments', function() {
