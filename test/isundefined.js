...
describe(`isundefined()`, function() {
    ...
    it(`should return false if its argument has any other type`,
        function () {
            expectfalse( isundefined(null) );
            expectfalse( isundefined(markerobject) );
            expectfalse( isundefined(markerarray) );
            expectfalse( isundefined(42) );
            expectfalse( isundefined('foobar') );
            expectfalse( isundefined(true) );
