...
describe( 'apply()', function() {
        ...
        it(`should pass its second argument as the second argument to the 'apply()' method of the target function`, function() {
            const argarray = ['fubar', 42, {}];
            apply(collectargs, argarray);
            expect(fakeapplycollectargs.args[0][1]).to.deep.equal(argarray);
        })

        it(`should return the return value of the call to the 'apply()' method of the target function`, function() {
            const argarray = ['fubar', 42, {}];
