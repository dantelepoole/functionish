...
describe(`noop()`, function() {
    ...
    it(`should always return undefined regardless of its arguments`,
        function () {
            expectundefined( noop() );
            expectundefined( noop(undefined) );
            expectundefined( noop(null) );
            expectundefined( noop(42) );
            expectundefined( noop('f', 'o', 'o', 'b', 'a', 'r') );
        }
    )
