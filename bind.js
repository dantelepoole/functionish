...
const notfunction = value => (typeof value !== 'function');
 ...
 * 
 * If *func* is not a function, it is interpreted as the name of the *context*-method to bind.
 * 
...
module.exports = function bind(func, context, ...args) {
    ...
    if( notfunction(func) ) func = context[func];
