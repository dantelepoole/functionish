...
const curry1 = func => (...args) => (args.length === 0) ? func
                                  : (args.length === 1) ? func.bind(null, ...args)
                                  : func(...args);
const isvoid = value => (value === null) || (value === undefined);

/**
 * SHOULD BE/CONFORM FUNCTIONS
 */

const should_be = curry1( (comparator, x) => expect( evaluate(x) ).equals(comparator) );
const should_be_a = curry1( (type, x) => expect( typeof evaluate(x) ).to.equal(type) );
...
const should_be_empty = x => expect( evaluate(x).length ?? evaluate(x).size ?? [...evaluate(x)].length ).equals(0);
const should_be_false = x => expect( evaluate(x) ).is.false;
const should_be_falsy = x => expect( !!evaluate(x) ).is.false;
const should_be_greater_than = curry1( (min, x) => expect( evaluate(x) > min ).to.be.true );
const should_be_greater_than_or_equal = curry1( (min, x) => expect( evaluate(x) >= min ).to.be.true );
const should_be_instance_of = curry1( (classofx, x) => expect( evaluate(x) ).is.instanceof(classofx) );
const should_be_iterable = x => expect( evaluate(x)?.[Symbol.iterator] ).to.be.a('function');
const should_be_less_than = curry1( (max, x) => expect( evaluate(x) < max ).to.be.true );
const should_be_less_than_or_equal = curry1( (max, x) => expect( evaluate(x) <= max ).to.be.true );
...
const should_conform = curry1( (predicate, x) => expect( !!predicate(evaluate(x))).to.be.true);
const should_not_be = curry1( (comparator, x) => expect( evaluate(x) ).not.equal(comparator) );
const should_not_be_a = (type, x) => expect( typeof evaluate(x) ).not.equal(type);
...
const should_not_be_empty = x => expect( evaluate(x).length ?? evaluate(x).size ?? [...evaluate(x)].length ).not.equals(0);
const should_not_be_false = x => expect( evaluate(x) ).is.not.false;
const should_not_be_falsy = x => expect( !!evaluate(x) ).is.not.false;
const should_not_be_greater_than = curry1( (min, x) => expect( evaluate(x) > min ).to.be.false );
const should_not_be_greater_than_or_equal = curry1( (min, x) => expect( evaluate(x) >= min ).to.be.false );
const should_not_be_instance_of = curry1( (classofx, x) => expect( evaluate(x) ).is.not.instanceof(classofx) );
const should_not_be_iterable = obj => expect( obj?.[Symbol.iterator] ).not.to.be.a('function');
const should_not_be_less_than = curry1( (max, x) => expect( evaluate(x) < max ).to.be.false );
const should_not_be_less_than_or_equal = curry1( (max, x) => expect( evaluate(x) <= max ).to.be.false );
...
const should_not_conform = curry1( (predicate, x) => expect( !!predicate(evaluate(x))).not.to.be.true);
...
module.exports.be.an = should_be_a;
module.exports.be.an.Array = should_be_an_Array;
module.exports.be.an.Error = should_be_an_Error;
...
module.exports.be.greater = { than:should_be_greater_than };
module.exports.be.greater.than.or = { equal:{ to:should_be_greater_than_or_equal } };
module.exports.be.instanceof = should_be_instance_of;
module.exports.be.iterable = should_be_iterable;
module.exports.be.less = { than:should_be_less_than };
module.exports.be.less.than.or = { equal:{ to:should_be_less_than_or_equal } };
...
module.exports.conform = should_conform;
module.exports.not = {};
...
module.exports.not.be.an = should_not_be_a;
module.exports.not.be.an.Array = should_not_be_an_Array;
module.exports.not.be.an.Error = should_not_be_an_Error;
...
module.exports.not.be.greater = { than:should_not_be_greater_than };
module.exports.not.be.greater.than.or = { equal:{ to:should_not_be_greater_than_or_equal } };
module.exports.not.be.instanceof = should_not_be_instance_of;
module.exports.not.be.iterable = should_not_be_iterable;
module.exports.not.be.less = { than:should_not_be_less_than };
module.exports.not.be.less.than.or = { equal:{ to:should_not_be_less_than_or_equal } };
...
module.exports.not.conform = should_not_conform;
...
const should_return_a = curry1( (type, func, ...args) => expect( typeof func(...args) ).to.equal(type) );
...
const should_return_conform = curry1( (predicate, func, ...args) => expect( !!predicate(func(...args))).to.be.true );
const should_return_an_Error = (func, ...args) => expect( nodetypes.isNativeError( func(...args) ) ).to.be.true;
const should_return_empty = (func, ...args) => expect( (func(...args).length ?? func(...args).size ?? [...func(...args)].length) ).equals(0);
...
const should_return_greater_than = curry1( (min, func, ...args) => expect( func(...args) > min ).to.be.true );
const should_return_greater_than_or_equal = curry1( (min, func, ...args) => expect( func(...args) >= min ).to.be.true );
const should_return_instance_of = curry1( (classofx, func, ...args) => expect( func(...args) ).is.instanceof(classofx) );
const should_return_iterable = (func, ...args) => expect( func(...args)?.[Symbol.iterator] ).to.be.a('function');
const should_return_less_than = curry1( (max, func, ...args) => expect( func(...args) < max ).to.be.true );
const should_return_less_than_or_equal = curry1( (max, func, ...args) => expect( func(...args) <= max ).to.be.true );
...
const should_not_return_a = curry1( (type, func, ...args) => expect( typeof func(...args) ).not.equal(type) );
...
const should_not_return_conform = curry1( (predicate, func, ...args) => expect( !!predicate(func(...args))).not.to.be.true );
const should_not_return_empty = (func, ...args) => expect( (func(...args).length ?? func(...args).size ?? [...func(...args)].length) ).not.equals(0);
...
const should_not_return_greater_than = curry1( (min, func, ...args) => expect( func(...args) > min ).to.be.false );
const should_not_return_greater_than_or_equal = curry1( (min, func, ...args) => expect( func(...args) >= min ).to.be.false );
const should_not_return_instance_of = curry1( (classofx, func, ...args) => expect( func(...args) ).not.is.instanceof(classofx) );
const should_not_return_iterable = (func, ...args) => expect( func(...args)?.[Symbol.iterator] ).not.to.be.a('function');
const should_not_return_less_than = curry1( (max, x) => expect( evaluate(x) < max ).to.be.false );
const should_not_return_less_than_or_equal = curry1( (max, x) => expect( evaluate(x) <= max ).to.be.false );
...
module.exports.return.a.value = { like:should_return_like };
module.exports.return.an = should_return_a;
module.exports.return.an.Array = should_return_an_Array;
module.exports.return.an.Error = should_return_an_Error;
module.exports.return.an.object = should_return_a('object');
module.exports.return.an.instanceof = should_return_instance_of;
module.exports.return.an.iterable = should_return_iterable;
module.exports.return.and = { conform:should_return_conform, not:{ conform:should_not_return_conform } };
...
module.exports.return.greater = { than:should_return_greater_than };
module.exports.return.greater.than.or = { equal:{ to:should_return_greater_than_or_equal } };
module.exports.return.less = { than:should_return_less_than };
module.exports.return.less.than.or = { equal:{ to:should_return_less_than_or_equal } };
...
module.exports.not.return.a.value = { like:should_not_return_like };
module.exports.not.return.an = should_not_return_a;
module.exports.not.return.an.Array = should_not_return_an_Array;
module.exports.not.return.an.Error = should_not_return_an_Error;
module.exports.not.return.an.instanceof = should_not_return_instance_of;
module.exports.not.return.an.iterable = should_not_return_iterable;
...
module.exports.not.return.greater = { than:should_not_return_greater_than };
module.exports.not.return.greater.than.or = { equal:{ to:should_not_return_greater_than_or_equal } };
module.exports.not.return.less = { than:should_not_return_less_than };
module.exports.not.return.less.than.or = { equal:{ to:should_not_return_less_than_or_equal } };
