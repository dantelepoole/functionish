...
const should_be = curry1( (comparator, x) => expect(x).equals(comparator) );
const should_be_a = curry1( (type, x) => expect( typeorclassname(x) ).equals(type) );
const should_be_empty = x => expect( (x.length ?? x.size) ).equals(0);
const should_be_false = x => expect(x).is.false;
const should_be_falsy = x => expect( !!x ).is.false;
const should_be_instance_of = x => expect(x).is.instanceof(x);
const should_be_like = curry1( (comparator, x) => expect(x).deep.equals(comparator) );
const should_be_nan = x => expect(x).is.NaN;
const should_be_null = x => expect(x).is.null;
const should_be_one = x => expect(x).equals(1);
const should_be_true = x => expect(x).is.true;
const should_be_truthy = x => expect( !!x ).is.true;
const should_be_type = curry1( (type, x) => expect(x).to.be.a(type) );
const should_be_undefined = x => expect(x).to.be.undefined;
const should_be_void = x => expect( isvoid(x)).to.be.true;
const should_be_zero = x => expect(x).equals(0);
const should_not_be = curry1( (comparator, x) => expect(x).not.equal(comparator) );
const should_not_be_a = (type, x) => expect(x).is.not.a(type);
const should_not_be_empty = x => expect( (x.length ?? x.size) ).not.equals(0);
const should_not_be_false = x => expect(x).is.not.false;
const should_not_be_falsy = x => expect( !!x ).is.not.false;
const should_not_be_instance_of = x => expect(x).is.not.instanceof(x);
const should_not_be_like = curry1( (comparator, x) => expect(x).not.deep.equals(comparator) );
const should_not_be_nan = x => expect(x).not.is.NaN;
const should_not_be_null = x => expect(x).is.not.null;
const should_not_be_one = x => expect(x).not.equals(1);
const should_not_be_true = x => expect(x).is.not.true;
const should_not_be_truthy = x => expect( !!x ).is.not.true;
const should_not_be_type = curry1( (type, x) => expect(x).is.not.a(type) );
const should_not_be_undefined = x => expect(x).is.not.undefined;
const should_not_be_void = x => expect( isvoid(x)).to.be.false;
const should_not_be_zero = x => expect(x).not.equals(0);
