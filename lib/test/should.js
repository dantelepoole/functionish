...
const should_be = curry( (comparator, x) => expect( evaluate(x) ).equals(comparator) );
const should_be_a = curry( (type, x) => expect( typeorclassname( evaluate(x) ) ).equals(type) );
...
const should_be_called_with = curry( (expectedargs, func) => expect( func.args[ func.args.length-1 ] ).to.deep.equal(expectedargs) );
...
const should_be_instance_of = curry( (classofx, x) => expect( evaluate(x) ).is.instanceof(classofx) );
const should_be_iterable = x => expect( evaluate(x)?.[Symbol.iterator] ).to.be.a('function');
const should_be_like = curry( (comparator, x) => expect( evaluate(x) ).deep.equals(comparator) );
...
const should_be_type = curry( (type, x) => expect( evaluate(x) ).to.be.a(type) );
...
const should_not_be = curry( (comparator, x) => expect( evaluate(x) ).not.equal(comparator) );
...
const should_not_be_instance_of = curry( (classofx, x) => expect( evaluate(x) ).is.not.instanceof(classofx) );
const should_not_be_iterable = obj => expect( obj?.[Symbol.iterator] ).not.to.be.a('function');
const should_not_be_like = curry( (comparator, x) => expect( evaluate(x) ).not.deep.equals(comparator) );
...
const should_not_be_type = curry( (type, x) => expect( evaluate(x) ).is.not.a(type) );
...
const should_not_throw_a = curry( (expected, func, ...args) =>  expect( ()=>func(...args) ).to.not.throw(expected) );
const should_throw = (func, ...args) =>  expect( () => func(...args) ).to.throw();
const should_throw_a = curry( (expected, func, ...args) =>  expect( () => func(...args) ).to.throw(expected) );
...
const should_return = curry( (comparator, func, ...args) => expect( func(...args) ).equals(comparator) );
const should_return_a = curry( (type, func, ...args) => expect( typeorclassname(func(...args)) ).equals(type) );
...
const should_return_instance_of = curry( (classofx, func, ...args) => expect( func(...args) ).is.instanceof(classofx) );
const should_return_iterable = (func, ...args) => expect( func(...args)?.[Symbol.iterator] ).to.be.a('function');
const should_return_like = curry( (comparator, func, ...args) => expect( func(...args) ).deep.equals(comparator) );
...
const should_return_type = curry( (type, func, ...args) => expect( func(...args) ).to.be.a(type) );
...
const should_not_return = curry( (comparator, func, ...args) => expect( func(...args) ).not.equal(comparator) );
const should_not_return_a = curry( (type, func, ...args) => expect( func(...args) ).is.not.a(type) );
...
const should_not_return_instance_of = curry( (classofx, func, ...args) => expect( func(...args) ).not.is.instanceof(classofx) );
const should_not_return_iterable = (func, ...args) => expect( func(...args)?.[Symbol.iterator] ).not.to.be.a('function');
const should_not_return_like = curry( (comparator, func, ...args) => expect( func(...args) ).not.deep.equals(comparator) );
...
module.exports.return.instanceof = should_return_instance_of;
module.exports.return.iterable = should_return_iterable;
...
module.exports.not.return.instanceof = should_not_return_instance_of;
module.exports.not.return.iterable = should_not_return_iterable;
