...
const will_be_a = curry1( (type, func, args=[], message) => expect( typeorclassname(func(...args), message) ).equals(type) );
...
const will_not_be_a = curry1( (type, func, args=[], message) => expect(func(...args), message).is.not.a(type) );
